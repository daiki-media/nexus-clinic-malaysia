...
const treatmentCategories: TreatmentCategory[] = [
  ...
  },
  {
    ...
    treatments: [
      { name: "Ozempic Weight Loss Malaysia", slug: "ozempic-malaysia", description: "Appetite control support for medical weight loss.", imageUrl: "/images/weight-loss/Ozempic Weight Loss Treatment.png" },
      { name: "Wegovy Weight Loss Malaysia", slug: "wegovy-malaysia", description: "Structured medical program for weight management.", imageUrl: "/images/weight-loss/Wegovy Weight Loss Treatment.png" },
      { name: "Mounjaro Weight Loss Malaysia", slug: "mounjaro-malaysia", description: "Advanced GLP-1 treatment for weight loss.", imageUrl: "/images/weight-loss/Mounjaro Weight Loss Treatment.png" },
      { name: "Duromine Weight Loss Malaysia", slug: "duromine-malaysia", description: "Short term doctor monitored weight loss support.", imageUrl: "/images/weight-loss/Duromine Weight Loss Treatment.png" },
      ...
      { name: "HCG Weight Loss Malaysia", slug: "hcg-programme-malaysia", description: "Doctor guidance on HCG related weight loss plans.", imageUrl: "/images/weight-loss/HCG Weight Loss Program Treatment.png" },
      ...
      { name: "Zepbound Weight Loss Malaysia", slug: "zepbound-malaysia", description: "Doctor-led information on Zepbound treatment.", imageUrl: "/images/weight-loss/ZepBound Weight Loss Treatment.png" },
      { name: "IV Drip Weight Loss Malaysia", slug: "iv-drip-malaysia", description: "Supportive wellness & hydration IV options.", imageUrl: "/images/weight-loss/IV Drip for Weight Loss Treatment.png" },
    ]
  },
  {
