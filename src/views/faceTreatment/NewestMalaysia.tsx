...
export default function NewestMalaysia({ locale = fallbackLng }: NewestMalaysiaProps) {
  const { t } = useTranslation(locale, "face/newestMalaysia");
            ...
            <motion.div variants={fadeInRight} className="relative">
              <div className="relative rounded-2xl overflow-hidden shadow-xl aspect-[4/3]">
                <Image
                  ...
                  alt={whatIs?.imageAlt || "NEWEST polynucleotide skin booster treatment at Nexus Clinic KL"}
                  fill
